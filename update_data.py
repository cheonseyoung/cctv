    ...
    def aaa(i):
        try:
            a = '''<p>
                 ...
                 <span class="s22"> <input type="text" name="File_Path''' + str(i) + '"'''' size=50 value=''' + \
                get_value[0] + '''></span>
            ...
            a = '''<p><span class="s21">''' + str(i) + '''th</span>
                <span class="s22"> <input type="text" name="File_Path''' + str(
                i) + '"' '''id='File_Path' size=50 value=''' + get_value[0] + '''></span>
                <span class="s23"> <input type="text" name="Url''' + str(i) + '"' ''' id='Url' size=50 value=''' + \
                get_value[1] + '''></span>
                 <span><input type="hidden" name="list1" size=50 ></span>
                 <span><input type="hidden" name="list2" size=50 ></span>
                 <span class="s29"> </span>
