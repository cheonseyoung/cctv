...
#         bb += aaa(j,c[j-1],got_data[str(j-1)])
#
#     return '''
# <!DOCTYPE html>
# <html lang="en">
...
#                 i) + '"'''' value="Clear" style="width: 100px;"> </span></br>'''
#         except:
#
#             a = '''<p><span class="s21">''' + str(i) + '''th</span>
#                 <span class="s22"> <input type="text" name="File_Path''' + str(i) + '"' '''id='File_Path' size=50 value=''' + get_value[0] + '''></span>
...
#     var messageTextArea = document.getElementById("fps1");
#     // 소켓 접속이 되면 호출되는 함수
#     function sendMessage(){
#         var message = document.getElementById("fps1");
#         messageTextArea.value += "Send to Server => "+message.value+"\n";
#         //웹소켓으로 textMessage객체의 값을 보낸다.
#         webSocket.r(message.value); //textMessage객체의 값 초기화
#         message.value = "";
#     }
